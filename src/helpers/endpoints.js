...
export const ROOM_PRICE_LIST_ENDPOINT = BASE_URL + 'rooms/rooms-price/';

export const COSTUMER_LIST_ENDPOINT = BASE_URL + 'customers/list/';
export const COSTUMER_UPDATE_ENDPOINT = BASE_URL + '';
export const COSTUMER_DELETE_ENDPOINT = BASE_URL + '';

export const RESERVATION_LIST_ENDPOINT = BASE_URL + 'reservations/list/';
export const RESERVATION_UPDATE_ENDPOINT = BASE_URL + 'reservations/detail/';